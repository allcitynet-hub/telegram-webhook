...
const BOT_USERNAME = '@Allcitynet_bot'; // Замените на ваш домен
    ...
    try {
        ...
        if (update.message) {
            ...
            if (text.toLowerCase().includes('привет') || text.toLowerCase().includes('hello')) {
                ...
                await sendMessage(chatId, `🆘 <b>Помощь по боту Allcitynet Portal</b>

📋 <b>Доступные команды:</b>
• <b>Привет</b> - приветствие
• <b>Статус</b> - информация о статусе заявок
...
По вопросам работы портала обращайтесь к администратору.`);
                ...
                await sendMessage(chatId, `📝 <b>Информация о заявках</b>
...
Убедитесь, что ваш username настроен в системе для получения уведомлений.`);
                ...
                await sendMessage(chatId, `🤖 <b>Спасибо за сообщение!</b>
...
📋 <b>Для получения помощи</b> напишите "помощь" или "help".`);
            }
        }
